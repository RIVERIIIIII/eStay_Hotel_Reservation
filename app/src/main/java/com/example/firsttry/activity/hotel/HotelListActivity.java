...
public class HotelListActivity extends AppCompatActivity {
    ...
    private String currentSort = "recommend"; // recommend, distance, price_asc
    ...
    private void showFilterPopup(View anchor) {
        ...
        // 设置筛选结果监听器
        filterDialog.setOnFilterAppliedListener((minPrice, maxPrice, starRating) -> {
            // 将筛选结果保存到searchQuery中
    ...
    private void refreshList() {
        ...
        HotelApi.getHotelList(searchQuery, new HotelApi.HotelListCallback() {
                ...
                public void onSuccess(List<HotelModel> hotels) {
                    ...
                    Toast.makeText(HotelListActivity.this, "加载成功", Toast.LENGTH_SHORT).show();
                }
                ...
                public void onFailure(IOException e) {
                    Toast.makeText(HotelListActivity.this, "网络请求失败", Toast.LENGTH_SHORT).show();
                }
            }
        );
    }
